...
| [`build_strategy_live_application`](../../src/ogami_oanda/entrypoints/live.py#L1182) | function | 検証済み戦略のlive依存を構築し、任意のnotification_strategy_nameを通知インスタンスへ渡す。 |
| [`main`](../../src/ogami_oanda/entrypoints/live.py#L1359) | function | 引数を検証し、smoke・組込み・戦略プラグインの経路を選び実行する。 |
...
| [`_notification_strategy_name`](../../src/ogami_oanda/entrypoints/live.py#L1352) | function / internal | 解決済みプラグインパスから通知用の安定したstrategy名を選ぶ。 |
