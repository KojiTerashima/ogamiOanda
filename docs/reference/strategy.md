...
| [`OriginalStrategy.__init__`](../../src/ogami_oanda/strategy/original/strategy.py#L36) | method | 依存・設定を受け取り初期状態を構築する。 |
| [`OriginalStrategy.decide`](../../src/ogami_oanda/strategy/original/strategy.py#L70) | method | 共通市場入力から戦略判断を返す。 |
| [`OriginalStrategy.dump_state`](../../src/ogami_oanda/strategy/original/strategy.py#L114) | method | JSON互換の戦略状態を返す。 |
| [`OriginalStrategy.load_state`](../../src/ogami_oanda/strategy/original/strategy.py#L117) | method | 保存された戦略状態を検証して読み込む。 |
| [`create_strategy`](../../src/ogami_oanda/strategy/original/strategy.py#L123) | function | originalのAPI v1判断、データ要件、空の状態読込とfactoryを提供する。 |
| [`OriginalStrategy.bind_main_analysis`](../../src/ogami_oanda/strategy/original/strategy.py#L65) | method | 評価状態と既存の呼び出し契約を接続する。 |
