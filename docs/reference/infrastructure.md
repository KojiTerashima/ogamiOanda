...
| [`load_settings`](../../src/ogami_oanda/infrastructure/config/loader.py#L53) | function | YAMLと環境変数から設定を読み取り、必要項目を検証する。 |
| [`_validate_settings`](../../src/ogami_oanda/infrastructure/config/loader.py#L116) | function / internal | 口座必須値・環境・ペア・枠合計を検証する。 |
| [`_strategy_pair_webhooks`](../../src/ogami_oanda/infrastructure/config/loader.py#L39) | function / internal | strategyと通貨ペアの二段マッピングを検証し、環境変数を展開する。 |
