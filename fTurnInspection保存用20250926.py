        ...
        if r["count"] == 2 and t["count"] >= 4:
            ...
            if self.rt.lo_ratio <= 0.3:
                ...
                if self.tf.lo_ratio <= 0.26:
                    ...
                    self.tf.lo_ratio > 1.45
                    and self.rt.lo_ratio >= 0.195
                    and self.rt.skip_num_at_older < 4
                ):
            ...
            if (
                (self.rt.skip_exist_at_older or 7 <= t["count"] < 100)
                and self.rt.skip_num_at_older < 3
                and 0 < self.rt.turn_strength_at_older <= 8
            ):
    ...
    def single_peak_additional_information_later(self, peak_no):
        ...
        if peak_no == 0:
            ...
            if (
                ...
                print(
                    "　　◎リバーの方向が全部同じ（正方向）",
                    self.second_last_close_price_later,
                )
            elif (
                target_peak["direction"] == -1
                and latest_df["body"] < 0
